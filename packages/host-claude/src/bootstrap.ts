/**
 * Claude Code bootstrap surface — re-exported from the shared runtime's
 ...
 * chain (ADR-0006), identical to the pre-runtime claude bootstrap.
 */
...
const kit = createBootstrap(CLAUDE_DESCRIPTOR, createConfigSpace(CLAUDE_DESCRIPTOR))
