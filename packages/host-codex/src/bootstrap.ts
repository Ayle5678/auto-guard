/**
 * Codex bootstrap surface — re-exported from the shared runtime's
 ...
 * chain (ADR-0006), rooted at `~/.codex/auto-guard/`.
 */
...
const kit = createBootstrap(CODEX_DESCRIPTOR, createConfigSpace(CODEX_DESCRIPTOR))
